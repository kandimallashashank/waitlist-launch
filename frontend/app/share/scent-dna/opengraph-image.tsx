...
export const alt = "ScentRev · Fragrance DNA";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

/**
 * Link-preview art for ``/share/scent-dna`` (WhatsApp, iMessage, Twitter, etc.).
 */
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flex: 1, flexDirection: "column", justifyContent: "center" }}>
          ...
          >
            Map your scent profile. Share a story-sized card. Built for India.
          </p>
        </div>
        <div
          style={{
